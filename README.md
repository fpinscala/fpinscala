[![Build status](https://travis-ci.org/k-scala-lab/fpinscala.svg?branch=k-branch)](https://travis-ci.org/k-scala-lab/fpinscala) [![Join the chat at https://gitter.im/fpinscala/fpinscala](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/fpinscala/fpinscala?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) 
